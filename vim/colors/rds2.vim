...
" I don't want to abuse folding, but here folding is used to avoid confusion. 
  ...
  hi Comment            guifg=#ffd700   guibg=NONE      gui=NONE " dark yellow
  hi Constant           guifg=#ffa500   guibg=NONE      gui=NONE " white
"  hi Number             guifg=white     guibg=NONE      gui=NONE
  hi Identifier         guifg=#00fa9a   guibg=NONE      gui=NONE " green
  hi Statement          guifg=#00ffff   guibg=NONE      gui=NONE " turqoise
  hi String             guifg=#ffa500   guibg=NONE      gui=NONE " orange
  hi PreProc            guifg=#00ffff   guibg=NONE      gui=NONE
  hi Type               guifg=#b0c4de   guibg=NONE      gui=NONE 

"  hi Special            guifg=#e0c060   guibg=NONE      gui=NONE
  hi Special            guifg=#ffd700   guibg=NONE      gui=NONE "also string delimiters

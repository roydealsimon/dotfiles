...
(defvar espresso-mode-map
  (let ((keymap (make-sparse-keymap)))
    ...
    (easy-menu-define nil keymap "Espresso Menu"
      '("Javascript"
        ["Select new Mozilla context‰Û?" espresso-set-js-context
         (fboundp #'inferior-moz-process)]
        ["Evaluate expression in Mozilla context‰Û?" espresso-js-eval
         (fboundp #'inferior-moz-process)]
        ["Send current function to Mozilla‰Û?" espresso-eval-defun
         (fboundp #'inferior-moz-process)]
        )
      )
